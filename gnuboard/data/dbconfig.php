...
define('G5_MYSQL_USER', 'jeonbukwoorisai');
define('G5_MYSQL_PASSWORD', 'wjsqnrdnfltkdl1!');
define('G5_MYSQL_DB', 'jeonbukwoorisai');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '002db8669ef9b25ca9cfbe3747df3f5b'); // 토큰 암호화에 사용할 키
